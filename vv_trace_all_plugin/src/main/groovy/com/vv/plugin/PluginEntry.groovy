package com.vv.plugin

import com.android.build.gradle.AppExtension
import com.android.build.gradle.BaseExtension
import com.vv.plugin.asm.AutoTransform
import com.vv.plugin.bean.AutoClassFilter
import com.vv.plugin.bean.AutoSettingParams
import com.vv.plugin.util.AutoTextUtil
...
class PluginEntry implements Plugin<Project> {
    ...
    void apply(Project project) {
        project.extensions.create('vv', AutoSettingParams)
        ...
        project.afterEvaluate {
            Logger.setDebug(project.vv.isDebug)
            // 用户配置解析
            analysiUserConfig()
        }
    }
