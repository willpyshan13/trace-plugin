...
import com.vv.plugin.LogHookConfig
import com.vv.plugin.bean.AutoClassFilter
import com.vv.plugin.bean.LogMethodCell
import com.vv.plugin.util.LogAnalyticsUtil
import com.vv.plugin.util.Logger
...
public class AutoClassVisitor extends ClassVisitor {
    ...
    MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        if (GlobalConfig.isOpenLogTrack) {
            MethodVisitor logMethodVisitor = new TrackMethodAdapter(methodVisitor, access, name, desc, mSuperName, mClassName, mInterfaces, visitedFragMethods)
